               ...
               <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="well">
                            ...
                            <form class="form-horizontal" action="<?php echo site_url('home/jabatan_s');?>" method="post">
                        <fieldset>
	...
	echo ! empty($flashmessage) ? '<p class="message">' . $flashmessage . '</p>': '';
        ?></i></legend>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="kode_jabatan" required="" readonly="" value="<?php echo $auto;?>" class="form-control"  placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail" class="col-lg-2 control-label">Nama Jabatan</label>
                                <div class="col-lg-10">
                                    <input type="text" name="nama_jabatan"  required="" class="form-control"  placeholder="">
                                </div>
                            </div>
