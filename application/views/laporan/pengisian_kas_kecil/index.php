               ...
               <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="well">
                            ...
                            <form class="form-horizontal" action="<?php echo site_url('laporan/l_c_pengisian');?>" method="post">
                        <fieldset>
                            <legend>Laporan Pengisian Kas Kecil  &nbsp; <i style="color: #F1C40F; size: 12px;"><?PHP
	...
	echo ! empty($flashmessage) ? '<p class="message">' . $flashmessage . '</p>': '';
        ?></i></legend>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="tgl1" required="" id="datepicker" class="form-control"  placeholder="">
